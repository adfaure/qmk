...
[_BEPO] = {
  ...
  {KC_LCTL, BP_DOLLAR, KC_LALT, KC_LGUI, BP_LOWER,  KC_BSPC, KC_SPC,  BP_RAISE, KC_LALT, KC_BSPC, BP_PERC, KC_ENT}
},
 ...
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |  F6  |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |ISO ~ |ISO | | Home | End  |  |   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      | Next | Vol- | Vol+ | Play |
 * `-----------------------------------------------------------------------------------'
 */
[_BP_RAISE] = {
  ...
  {KC_DEL,  BP_PIPE, _______,  BP_AMPR, BP_OE,   _______, KC_F6,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______},
 ...
 * | Del  |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |   -  |   =  |   [  |   ]  |  \   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |  _   |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |ISO # |ISO / |Pg Up |Pg Dn |  _   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      | Next | Vol- | Vol+ | Play |
 * `-----------------------------------------------------------------------------------'
 */
[_BP_LOWER] = {
  {BP_DLR,  BP_DQOT, BP_LGIL, BP_RGIL, BP_LPRN, BP_RPRN, BP_AT,   BP_PLUS, BP_MINUS, BP_ASTR, BP_EQL,  BP_PERC},
